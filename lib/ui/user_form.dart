...
class _UserFormState extends State<UserForm> {
  ...
  sendUserDataToDB()async{
    ...
    //print("user data added")).catchError((error) => print("Something is wrong"));
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=>BottomNavController()))).catchError((error)=>print("something is wrong. $error"));
  }
